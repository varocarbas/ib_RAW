...
public class basic extends parent_static 
{
	...
	public static String get_class_id() { return accessory.types.get_id(types.ID_BASIC); }
	...
	private static String get_user_internal()
	{
		...
		return strings.truncate(user, db_ib.common.MAX_LENGTH_USER);
	}
}