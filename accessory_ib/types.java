...
public class types
{
	...
	{		
		return new String[]
		{
			...
			CONFIG_DB_FIELD_CONN_TYPE, CONFIG_DB_FIELD_START, CONFIG_DB_FIELD_START2, CONFIG_DB_FIELD_STOP, 
			CONFIG_DB_FIELD_ORDER_ID_MAIN, CONFIG_DB_FIELD_ORDER_ID_SEC, CONFIG_DB_FIELD_STATUS, CONFIG_DB_FIELD_STATUS2, 
