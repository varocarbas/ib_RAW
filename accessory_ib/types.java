...
public abstract class types
{
	...
	public static final String CONFIG_DB_IB_FIELD_INVEST_PERC = "config_db_ib_field_invest_perc";
	...
	{		
		return new String[]
		{
			...
			CONFIG_DB_IB_FIELD_REQUEST, CONFIG_DB_IB_FIELD_TYPE_PLACE, CONFIG_DB_IB_FIELD_TYPE_MAIN, CONFIG_DB_IB_FIELD_TYPE_SEC, 
			CONFIG_DB_IB_FIELD_TIME_ELAPSED, CONFIG_DB_IB_FIELD_ELAPSED_INI, CONFIG_DB_IB_FIELD_UNREALISED, CONFIG_DB_IB_FIELD_IS_ACTIVE, 
			CONFIG_DB_IB_FIELD_POSITION, CONFIG_DB_IB_FIELD_INVESTMENT, CONFIG_DB_IB_FIELD_END, CONFIG_DB_IB_FIELD_REALISED, 
			...
			CONFIG_DB_IB_FIELD_FLU2_MIN, CONFIG_DB_IB_FIELD_FLU2_MAX, CONFIG_DB_IB_FIELD_FLU_PRICE, CONFIG_DB_IB_FIELD_APP, 
			CONFIG_DB_IB_FIELD_CONN_ID, CONFIG_DB_IB_FIELD_CONN_TYPE, CONFIG_DB_IB_FIELD_COUNT, CONFIG_DB_IB_FIELD_ERROR, 
			CONFIG_DB_IB_FIELD_ADDITIONAL,
