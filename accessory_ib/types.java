...
public abstract class types
{
	...
	public static final String CONFIG_DB_IB_FIELD_FLUS_ELAPSED_INI = "config_db_ib_field_flus_elapsed_ini";
...
<<<<<<< HEAD
=======
	public static final String ERROR_IB_ASYNC_DATA = "error_ib_async_data";
	public static final String ERROR_IB_ASYNC_DATA_APP = "error_ib_async_data_app";

>>>>>>> 27d4a4731cfee702eebf5ef3c68acbd305d19d93
	...
	{		
		return new String[]
		{
			...
			CONFIG_DB_IB_FIELD_IS_ACTIVE, CONFIG_DB_IB_FIELD_INVESTMENT, CONFIG_DB_IB_FIELD_END, CONFIG_DB_IB_FIELD_REALISED, 
			CONFIG_DB_IB_FIELD_PRICE_INI, CONFIG_DB_IB_FIELD_PRICE_MIN, CONFIG_DB_IB_FIELD_PRICE_MAX, CONFIG_DB_IB_FIELD_VOLUME_INI, 
			CONFIG_DB_IB_FIELD_VOLUME_MIN, CONFIG_DB_IB_FIELD_VOLUME_MAX, CONFIG_DB_IB_FIELD_FLU, CONFIG_DB_IB_FIELD_FLU2, CONFIG_DB_IB_FIELD_FLU2_MIN, 
<<<<<<< HEAD
			CONFIG_DB_IB_FIELD_FLU2_MAX, CONFIG_DB_IB_FIELD_FLUS_PRICE, CONFIG_DB_IB_FIELD_FLUS_ELAPSED_INI, CONFIG_DB_IB_FIELD_VAR_TOT, CONFIG_DB_IB_FIELD_APP, 
			CONFIG_DB_IB_FIELD_CONN_ID, CONFIG_DB_IB_FIELD_CONN_TYPE, CONFIG_DB_IB_FIELD_COUNT, CONFIG_DB_IB_FIELD_ERROR, CONFIG_DB_IB_FIELD_ADDITIONAL, 
			CONFIG_DB_IB_FIELD_TIME2, CONFIG_DB_IB_FIELD_ID, CONFIG_DB_IB_FIELD_TYPE, CONFIG_DB_IB_FIELD_DATA_TYPE, CONFIG_DB_IB_FIELD_DATE,
=======
			CONFIG_DB_IB_FIELD_FLU2_MAX, CONFIG_DB_IB_FIELD_FLU_PRICE, CONFIG_DB_IB_FIELD_VAR_TOT, CONFIG_DB_IB_FIELD_APP, CONFIG_DB_IB_FIELD_CONN_ID, 
			CONFIG_DB_IB_FIELD_CONN_TYPE, CONFIG_DB_IB_FIELD_COUNT, CONFIG_DB_IB_FIELD_ERROR, CONFIG_DB_IB_FIELD_ADDITIONAL, CONFIG_DB_IB_FIELD_TIME2, 
			CONFIG_DB_IB_FIELD_ID, CONFIG_DB_IB_FIELD_TYPE, CONFIG_DB_IB_FIELD_DATA_TYPE, CONFIG_DB_IB_FIELD_DATE,
>>>>>>> 27d4a4731cfee702eebf5ef3c68acbd305d19d93
			...
			ORDERS_STATUS_ACTIVE, ORDERS_STATUS_INACTIVE, ORDERS_STATUS_IN_PROGRESS,
			...
			REMOTE_REQUEST,
			REMOTE_REQUEST_OK, REMOTE_REQUEST_ERROR, REMOTE_REQUEST_IGNORED,
