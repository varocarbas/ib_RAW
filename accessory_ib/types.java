...
public class types
{
	...
	{		
		return new String[]
		{
			...
			CONFIG_DB_FIELD_CONN_TYPE, CONFIG_DB_FIELD_ACCOUNT_ID, CONFIG_DB_FIELD_START, CONFIG_DB_FIELD_START2, 
			CONFIG_DB_FIELD_STOP, CONFIG_DB_FIELD_ORDER_ID_MAIN, CONFIG_DB_FIELD_ORDER_ID_SEC, CONFIG_DB_FIELD_STATUS, 
			CONFIG_DB_FIELD_STATUS2, CONFIG_DB_FIELD_IS_MARKET, CONFIG_DB_FIELD_TYPE_PLACE, CONFIG_DB_FIELD_TYPE_MAIN, 
			CONFIG_DB_FIELD_TYPE_SEC,
