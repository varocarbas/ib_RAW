...
public class _ini_db extends parent_ini_db 
{
	...
	public static db_field get_symbol(boolean is_unique_) { return get_string(contracts.MAX_LENGTH_SYMBOL_US_ANY, is_unique_); }
	
	public static db_field get_order_id(boolean is_unique_) { return (is_unique_ ? new db_field(data.INT, db_field.DEFAULT_SIZE, db_field.WRONG_DECIMALS, ib.common.WRONG_ORDER_ID, new String[] { db_field.KEY_UNIQUE }) : new db_field(data.INT)); }
	
	public static db_field get_money() { return get_decimal(common.MAX_SIZE_MONEY); }
	...
	public static db_field get_decimal(int size_) { return new db_field(data.DECIMAL, size_, numbers.DEFAULT_DECIMALS); }
	
	public static db_field get_price() { return new db_field(data.DECIMAL, common.MAX_SIZE_PRICE, 2); }
	
	public static db_field get_halted() { return get_tiny(); }
	
	public static db_field get_boolean(boolean default_) { return new db_field(data.BOOLEAN, db_field.DEFAULT_SIZE, db_field.WRONG_DECIMALS, default_, null); }
	
	public static db_field get_halted_tot() { return get_tiny(); }
	
	public static db_field get_tiny() { return get_tiny(false); }
	
	public static db_field get_tiny(boolean is_unique_) { return (is_unique_ ? new db_field(data.TINYINT, db_field.DEFAULT_SIZE, db_field.WRONG_DECIMALS, db_field.WRONG_DEFAULT, new String[] { db_field.KEY_UNIQUE }) : new db_field(data.TINYINT)); }
	
	public static db_field get_time() { return get_time(ib.common.FORMAT_TIME); }
	
	public static db_field get_time2() { return get_time(ib.common.FORMAT_TIME2); }

	public static db_field get_time_elapsed() { return get_time(ib.common.FORMAT_TIME_ELAPSED); }
	
	public static db_field get_elapsed_ini() { return new db_field(data.LONG); }
	
	public static db_field get_user() { return get_user(false); }
	
	public static db_field get_user(boolean is_unique_) { return get_string(common.MAX_SIZE_USER, is_unique_); }
	
	public static db_field get_status_type() { return get_status_type(null); }
	...
	public static db_field get_request() { return get_int(true); }
	
	public static db_field get_int() { return get_int(false); }
	
	public static db_field get_int(boolean is_unique_) { return new db_field(data.INT, db_field.DEFAULT_SIZE, db_field.WRONG_DECIMALS, db_field.DEFAULT_DEFAULT, (is_unique_ ? new String[] { db_field.KEY_UNIQUE } : null)); }
	
	public static db_field get_string() { return get_string(db_ib.common.DEFAULT_SIZE_STRING); }
	
	public static db_field get_string(int size_) { return get_string(size_, false); }
	...
	private HashMap<String, Object[]> add_source_watchlist(String db_, HashMap<String, Object[]> sources_)
	{
		...
		info.put(watchlist.FLUS_PRICE, get_price());
		info.put(watchlist.FLUS_ELAPSED_INI, get_elapsed_ini());
